...
$thanks_1 = 'Сайт разработан на средства гранта Президента Российской Федерации для поддержки творческих проектов общенационального значения в области культуры и искусства';
$thanks_2 = 'Проект создан при поддержке министерства культуры';
