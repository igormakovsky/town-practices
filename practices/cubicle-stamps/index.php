...
$id = 'cubicle-stamps'; // id страницы
$parent = 'practices'; // родительский элемент

require $_SERVER['DOCUMENT_ROOT'].'/includes/vars.php';

$title = $practice_12_id;
$practice_title = $practice_12; // название практики

$oblast = $practice_12_oblast; // область
$oblast_id = $practice_12_oblast_id;
$town = $practice_12_town;
$town_id = $practice_12_town_id; // город
$geotag = ''; //
...
$practice_type_a_id = $practice_12_type; // тип практики №1

$practice_type_2 = $type_0; // тип практики №2
$practice_type_3 = $type_0; // тип практики №3

$date_begin = '2016'; // дата начала практики
...
?>
    ...
    <section class="practice-content">
        ...
        <p>В Очерском краеведческом музее им. А.В. Нецветаева проводят мастер-классы по старинному промыслу – кубовой набойке. Каждый желающий с помощью специальных штампиков может разрисовать себе платочек или сумку и приобщится к промыслу, которым занимались наши предки.</p>
        ...
        <p>
            Мастерицы научились воссоздавать ту краску, которая использовалась при изготовлении вещей раньше – краска не выцветает и имеет очень высокое качество. Желающие могут создать вещи на мастер-классе с помощью этой краски, либо выбрать более дешевую современную.
        </p>

        <p class="small">Значение для города <em>(что изменилось для жителей)</em></p>
        <p>У жителей появилась новая форма досуга – дети и взрослые могут участвовать в мастер-классе, через который лучше запоминаются исторические факты и появляется желание изучать те промыслы, которыми занимались наш предки.</p>
